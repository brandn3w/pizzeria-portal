...
const PageNav = () => (
    ...
    <nav className={styles.component}>
        ...
        <Button className={styles.link} component={NavLink} exact to={`${process.env.PUBLIC_URL}/waiter`}  activeClassName='active'>Waiter</Button> 
        <Button className={styles.link} component={NavLink} exact to={`${process.env.PUBLIC_URL}/tables`}  activeClassName='active'>Tables</Button> 
